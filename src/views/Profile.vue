  ...
  <div class="profile-page">
    <div class="container-fluid body p-4">
      <div class="text">
        ...
        <p
          class="espace"
        >Lors des premiers contacts, soyez très calme. Laissez-le s’apporcher de vous sans bouger. S’il vient vous renifler, vous pouvez lui parler doucement, mais dans tous les cas, il doit pouvoir s’enfuir comme bon lui semble, car aucun lien de confiance ne peut se construire sous la contrainte.</p>

        <p
          class="espace"
        >Progressivement, il va faire connaissance avec son nouvel environnement et gagner en confiance. Certains membres de la famille sauront plus facilement l’apprivoiser, mais tout est affaire de patience et de douceur. Au fil des semaines, il reconnaîtra les voix, appréciera les caresses, et découvrira la hiérarchie du foyer.</p>

        <div class="text-center">
          <img
            src="../../public/img/images/cage-pour-lapin.jpg"
            alt="cage pour lapin"
            class="img-fluid"
          />
        </div>
